...
This page tracks interventions that are either high priority or commonly promoted in longevity circles.

## High-confidence, clinician-friendly topics
...
- Primary aim: cardiovascular resilience, VO₂ max, metabolic health, cognition.
- Watch for: cardiac symptoms, overtraining, joint limitations.
- Evidence status: strong.

### Blood pressure and lipid optimization

- Primary aim: reduce cardiovascular and cerebrovascular risk.
...
- Why tracked: FLOW subgroup analyses and a 2026 CKD-restricted RCT meta-analysis reinforce cardiorenal benefit for GLP-1 receptor agonists in indicated CKD/type 2 diabetes/ASCVD-risk contexts, and a newer FLOW analysis suggests fewer serious infection/hospitalization events in that same high-risk T2D+CKD context. A 2026 post hoc analysis of SURMOUNT/SUMMIT trials found broadly comparable tirzepatide efficacy and safety in adults ≥65 with obesity, a 2026 phase 3 retatrutide trial showed large HbA1c and weight reductions in younger adults with type 2 diabetes, and a 2026 TriNetX older-adult diabetes cohort found lower falls and femoral fractures with semaglutide/tirzepatide versus DPP-4 inhibitors. A 2026 body-composition meta-analysis also found that preferential adiposity reduction is plausible but direct muscle quantity/quality evidence remains sparse and low-certainty. A 2026 claims-based target-trial emulation reported a small higher incident-cancer diagnosis association for GLP-1 receptor agonists versus DPP-4 inhibitors, which should be treated as an unresolved safety signal rather than causal proof. Together these make incretin agonists an important watchlist area rather than a general longevity recommendation.
- Watch for: gastrointestinal effects, dehydration, gallbladder/pancreatitis concerns, excessive lean-mass loss or inadequate protein intake during weight reduction, frailty/nutrition issues, strength and physical-performance changes, kidney-function context, retinopathy monitoring when relevant, mixed bone density/fall/fracture evidence, rare ocular safety signals such as possible semaglutide-associated NAION/ischemic optic neuropathy, and unresolved cancer-signal surveillance; sudden vision changes warrant urgent clinician/eye-specialist evaluation.
- Evidence status: strong for indicated obesity/diabetes/cardiorenal contexts, including disease-specific evidence in CKD; safety monitoring remains important in older adults and this is not a general longevity-drug endorsement.

## Geroscience watchlist

### Rapamycin / rapalogs

- Why tracked: strong animal data and mechanistic rationale.
- Human longevity evidence: not yet definitive.
- Safety issues: immune effects, lipids, glucose, mouth ulcers, wound healing, dosing uncertainty.
- Repository stance: monitor trials and high-quality reviews; discuss only with an experienced physician.

### Metformin

- Why tracked: diabetes outcomes, possible aging-related associations.
- Human longevity evidence in non-diabetics: uncertain; 2026 DPP/DPPOS follow-up found lower multimorbidity risk with intensive lifestyle intervention but not metformin versus placebo among adults originally enrolled with prediabetes.
- Safety issues: B12 deficiency, GI effects, renal function considerations, possible exercise adaptation concerns.
