...
- Age-appropriate vaccination (for example influenza, COVID-19, RSV, pneumococcal, shingles per current clinical guidance): **Strong for preventing infection-related morbidity in indicated older adults; recent real-world evidence supports adjuvanted RSVPreF3 effectiveness against RSV-related hospitalization/complications in adults ≥60, 2025/26 Stockholm data support seasonal influenza vaccine protection against hospitalization in adults ≥65, and I-MOVE hospitalized-case data link influenza vaccination with lower in-hospital death among adults ≥65; observational COVID-19 vaccine-effectiveness estimates in elderly populations should be interpreted cautiously because healthy-vaccinee/frailty-related selection effects can be large**
